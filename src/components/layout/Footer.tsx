...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: 'https://www.linkedin.com/in/nexora-technologies-31103437a', label: 'LinkedIn' },
    { icon: Instagram, href: 'https://www.instagram.com/nex_ora_technologies/', label: 'Instagram' },
  ];
